...
function animate(){
    ...
    // tl = new TimelineLite()
    tl = new TimelineLite({repeat: 3, repeatDelay: 2.5}); // Repeat 3xs with a 2-second delay between repetitions
    ...
    .from(logoCopy_2x, .4, {y:5,opacity: 0, ease: Power1.easeInOut},"-=.3")
    
    // COPY ANIMATION
    .staggerFrom([c1_2x, c2_2x], .7, {opacity: 0, y:10, ease: Power1.easeInOut}, .1, "-=1.8")
    .from(loc1_2x, .7, {y:5,opacity: 0, ease: Power1.easeInOut},"-=.1")
    .from(loc2_2x, .7, {y:5,opacity: 0, ease: Power1.easeInOut},"-=.1")
