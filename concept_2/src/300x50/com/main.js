...
function animate(){
    ...
    tl 
    .set(line3, {x:0,scaleX: 0, transformOrigin: "right center"})
    .set(line4, {y:0,scaleY: 0, transformOrigin: "bottom center"})
    
    // LINE ANIMATION
    .to(line4, .6, {y:0, scaleY: 1, ease: Power1.easeInOut})
    .from(line1, .6, {width: 0, ease: Power1.easeInOut},"-=.1")
    .from(line2, .6, {height: 0, ease: Power1.easeInOut}, "-=.1")
    .to(line3, .6, {x:0, scaleX: 1, ease: Power1.easeInOut}, "-=.1")

    // LOGO ANIMATION
    .from(logo_2x, 1.6, {opacity: 0, ease: Power1.easeInOut},0)
    .from(logoCopy, .4, {y:10,opacity: 0, ease: Power1.easeInOut},"-=.2")
    .from(circ5_2x, .3, {opacity: 0, ease: Power1.easeInOut},"-=.2")
    
    // COPY ANIMATION
    .staggerFrom([c1_2x,c2_2x], .7, {opacity: 0, y:10, ease: Power1.easeInOut}, .2, 0)
    .staggerFrom([cta_2x,loc_2x], .5, {opacity: 0, y:10, ease: Power1.easeInOut}, .3)
    .call(returnTimer)
}
